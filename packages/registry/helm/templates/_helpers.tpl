...
*/}}
{{- define "registry.cloudProviderFlavor" -}}
...
*/}}
{{- define "registry.cloudProviderDockerRegistryUrl" -}}
...
*/}}
{{- define "registry.cloudProviderImagePullSecretName" -}}
